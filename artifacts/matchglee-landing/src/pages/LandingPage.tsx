...
export default function LandingPage() {
  ...
  const [submissions, setSubmissions] = useState<
    { type: "email" | "phone"; value: string; submittedAt: Date }[]
  >([]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const isPhone = phoneRegex.test(contactInput.replace(/\s/g, ""));
  ...
  const glassCard =
    "bg-white/10 backdrop-blur-md border border-white/20 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] rounded-3xl";

  return (
    <div className="min-h-screen bg-[#0A0118] text-white font-sans selection:bg-pink-500/30 overflow-x-hidden">
      {/* Background Orbs */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[-10%] -left-10 w-[40rem] h-[40rem] bg-purple-600/30 rounded-full blur-[120px] mix-blend-screen animate-pulse" />
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? "bg-[#0A0118]/80 backdrop-blur-xl border-b border-white/10 py-3"
            : "bg-transparent py-5"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              src="/images/matchglee-logo.jpeg"
              alt="MatchGlee Logo"
              className="w-10 h-10 rounded-xl object-cover"
            />
            <span className="text-xl font-bold tracking-tight">
              Match<span className="text-pink-500">Glee</span>
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="#updates"
              className={`text-sm font-medium px-5 py-2.5 rounded-full ${gradientBg} hover:scale-105 hover:shadow-[0_0_20px_rgba(236,72,153,0.4)] transition-all duration-300`}
            >
              Get Started
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <FadeIn className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tight mb-6">
              ...
              <span className={gradientText}>Professional</span> — Seamlessly
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a
                href="#updates"
                className={`flex items-center gap-2 px-8 py-4 rounded-full text-base font-semibold ${gradientBg} hover:scale-105 hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] transition-all duration-300`}
              >
                Get Started <ArrowRight className="w-4 h-4" />
              </a>
              <a
                href="#updates"
                className="px-8 py-4 rounded-full text-base font-semibold bg-white/5 border border-white/20 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm"
              >
                Get Updates
              </a>
            </div>
          ...
          <FadeIn delay={200} className="relative lg:h-[600px] flex justify-center items-center">
            <div className="relative z-10 w-[300px] md:w-[340px] rounded-[3rem] p-3 bg-gradient-to-b from-white/20 to-white/5 backdrop-blur-xl border border-white/20 shadow-2xl shadow-purple-500/20 transform md:rotate-[-5deg] hover:rotate-0 transition-transform duration-700 ease-out">
              ...
              <div className="rounded-[2.25rem] overflow-hidden bg-black relative">
                <img
                  src="/images/matchglee-app-ui.png"
            ...
            <div className={`absolute -right-10 top-20 w-48 p-4 ${glassCard} animate-bounce z-20 hidden md:block`}>
            ...
            <div className={`absolute -left-16 bottom-32 w-56 p-4 ${glassCard} z-20 hidden md:block`}
              style={{ animation: "bounce 5s infinite 0.5s" }}>
          ...
          <FadeIn>
            <div className={`p-8 md:p-12 ${glassCard} relative overflow-hidden`}>
              ...
              <div className="space-y-6 text-lg md:text-xl text-white/80 leading-relaxed font-light relative z-10 border-l-4 border-pink-500 pl-6 md:pl-8 py-2">
                ...
                <p>
                  MatchGlee isn't just about connecting profiles. It's about connecting people — authentically. Whether you're sharing your story, showcasing your work, or finding your tribe —{" "}
                  <span className="text-white font-medium">MatchGlee lets you do it your way.</span>
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <section
        id="mission"
        className="py-24 px-6 relative overflow-hidden flex items-center justify-center min-h-[60vh]"
      >
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <FadeIn>
            ...
            <h2 className="text-4xl md:text-6xl font-bold leading-tight md:leading-tight">
              ...
              <span className={gradientText}>personal expression</span> and{" "}
              <span className={gradientText}>professional identity</span> coexist effortlessly —
              empowering meaningful connections without boundaries.
            </h2>
          </FadeIn>
        </div>
      </section>
          ...
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-white/60 max-w-2xl mx-auto">
                Powerful features designed to help you express your full self and build a network that matters.
              </p>
            </div>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FadeIn delay={100} className="lg:col-span-2">
              <div className={`h-full p-8 ${glassCard} group hover:bg-white/15 transition-colors duration-300`}>
                ...
                <p className="text-white/60 text-lg leading-relaxed">
                  Switch between personal and professional modes effortlessly. Control what different connections see while maintaining one unified account.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={200}>
              <div className={`h-full p-8 ${glassCard} group hover:bg-white/15 transition-colors duration-300`}>
                ...
                <p className="text-white/60 leading-relaxed">
                  Connect based on interests, goals, and intent, not just job titles.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              <div className={`h-full p-8 ${glassCard} group hover:bg-white/15 transition-colors duration-300`}>
                ...
                <p className="text-white/60 leading-relaxed">
                  You decide exactly what to share and with whom. Total transparency, total control.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={400}>
              <div className={`h-full p-8 ${glassCard} group hover:bg-white/15 transition-colors duration-300`}>
                ...
                <p className="text-white/60 leading-relaxed">
                  Highlights, galleries, and dynamic content that tells your whole story.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={500}>
              <div className={`h-full p-8 ${glassCard} group hover:bg-white/15 transition-colors duration-300`}>
                ...
                <p className="text-white/60 leading-relaxed">
                  Communicate and connect instantly with built-in rich messaging tools.
                </p>
              </div>
            </FadeIn>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <div className="text-center mb-16 relative z-20">
              <h2 className="text-3xl md:text-5xl font-bold mb-6">
                Experience <span className={gradientText}>MatchGlee</span>
              </h2>
            </div>
          </FadeIn>
          ...
          <div className="relative max-w-4xl mx-auto flex justify-center">
            ...
            <FadeIn
              delay={400}
              className={`absolute top-1/4 -left-4 md:-left-20 w-40 md:w-48 p-4 ${glassCard} z-20`}
            >
            ...
            <FadeIn
              delay={600}
              className={`absolute bottom-1/4 -right-4 md:-right-20 w-40 md:w-48 p-4 ${glassCard} z-20`}
            >
              <div className="flex items-center gap-3 mb-2">
          ...
          <FadeIn>
            <div className={`p-8 md:p-14 ${glassCard} text-center relative overflow-hidden group`}>
              ...
              <div className="relative z-10">
                ...
                {formStatus === "success" ? (
                  <div className="bg-green-500/10 border border-green-500/30 text-green-400 rounded-2xl p-6 flex flex-col items-center justify-center">
                  ...
                  <form onSubmit={handleSubmit} className="max-w-md mx-auto relative">
                    <div className="flex flex-col sm:flex-row gap-3">
                      <div className="relative flex-1">
                        <input
                          ...
                          className={`w-full px-6 py-4 rounded-xl md:rounded-full bg-white/5 border ${
                            errorMessage
                              ? "border-red-500 focus:border-red-500"
                              : "border-white/10 focus:border-pink-500"
                          } text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-pink-500/20 transition-all`}
                      ...
                      <button
                        ...
                        className={`px-8 py-4 rounded-xl md:rounded-full font-semibold text-white transition-all duration-300 flex items-center justify-center min-w-[140px] ${
                          formStatus === "loading"
                            ...
                            : `${gradientBg} hover:scale-105 hover:shadow-[0_0_20px_rgba(236,72,153,0.4)]`
                        }`}
                      >
                        {formStatus === "loading" ? (
                    ...
                    {errorMessage && (
                      <p className="text-red-400 text-sm mt-3 text-left ml-4">{errorMessage}</p>
                    )}
                  </form>
                )}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
            <div className="flex items-center gap-3">
              <img
                src="/images/matchglee-logo.jpeg"
                alt="MatchGlee Logo"
                className="w-8 h-8 rounded-lg object-cover grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all"
              />
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="#" className="text-white/40 hover:text-pink-500 hover:scale-110 transition-all">
